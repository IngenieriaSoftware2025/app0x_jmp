...
const GuardarUsuario = async (event) => {
    ...
    const url = '/app0x_jmp/usuarios/guardarAPI';
    const config = {
        method: 'POST',
        body
    }
...
const BuscarUsuarios = async () => {
    ...
    const url = '/app0x_jmp/usuarios/buscarAPI';
    const config = {
        method: 'GET'
    }
...
const ModificarUsuario = async (event) => {
    ...
    const url = '/app0x_jmp/usuarios/modificarAPI';
    const config = {
        method: 'POST',
        body
    }
...
const EliminarUsuarios = async (e) => {
    ...
    if (AlertaConfirmarEliminar.isConfirmed) {
        ...
        const url = `/app0x_jmp/usuarios/eliminar?id=${idUsuario}`;
        const config = {
            method: 'GET'
        }
